// this is authentication api schema related code which is the concept of norman,
// the role is same as pkg/api/customization, but principal resource is bit different from other resournce,
// principals is just abstraction resource rancher used and this is not stored as CRD, this resource will be generated by converting user/token resource
package principals
